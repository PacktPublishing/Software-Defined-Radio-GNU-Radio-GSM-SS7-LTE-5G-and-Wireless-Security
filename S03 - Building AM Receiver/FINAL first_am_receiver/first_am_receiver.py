...
# Title: AM Receiver
# Author: typhoniks
# Description: Lecture on AM Receiver
...
class first_am_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "first_am_receiver")
...
def main(top_block_cls=first_am_receiver, options=None):
