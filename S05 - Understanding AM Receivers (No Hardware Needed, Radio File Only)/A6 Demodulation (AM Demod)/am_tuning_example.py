...
class am_tuning_example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "am_tuning_example")
        ...
        self.freq = freq = 880000
        self.center_freq = center_freq = 900000
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/typhoniks/Desktop/2024_am_example_typhoniks.iq', True, 0, 0)
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.qtgui_freq_sink_x_2, 0))
...
def main(top_block_cls=am_tuning_example, options=None):
